...
export default function CartModal() {
  return (
    <div className="absolute p-4 gap-2 top-12 right-2 w-64 flex flex-col rounded-lg shadow-lg z-20 bg-white">
      ...
      <div className="flex flex-row justify-between">
        <button className="p-2 px-4 shadow-md border-[1px] border-gray-100 rounded-md hover:shadow-gray-100">
          View cart
        </button>
